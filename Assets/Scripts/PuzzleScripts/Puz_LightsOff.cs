    ...
    void Update()
    {
        if(Input.GetMouseButtonDown(0))
        {
            ...
            { 
                ...
                if (hit.transform.name == "Q_LightsOff" && isStatueRange == true)
                {
                    cursorName = mouseController.mouseScriptCursorName;
                    if (cursorName == "Icon_Cursor_Sword" && hit.transform.name == "Q_LightsOff" && isStatueRange == true)
                    {
                        isClicked = true;
